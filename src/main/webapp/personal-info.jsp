...
<body>
				...
				<div class="col-lg-7">
					<nav class="header__menu">
						<ul>
							...
							<li><a href="product-management.jsp">Manage product</a></li>
	...
	<div class="flex-container">
		<div class="flex-item-left">
			...
			<div>
				<strong>Manage profile information for account security</strong>
			</div>
			<div>
				<label class="form-label format-label">Username:</label>
				<label class="result format-label">${username}</label>
			</div>
			<div>
				<label class="form-label format-label">Full name:</label>
					<label class="result format-label">${fullName}</label>
			</div>
			<div>
				<label class="form-label format-label">Gender:</label>
					<label class="result format-label">${gender}</label>
			</div>
			<div>
				<label class="form-label format-label">Date of birth:</label>
					<label class="result format-label">${dateOfBirth}</label>
			</div>
			<div>
				<label class="form-label format-label">Phone number:</label>
			...
			<div>
				<a href="log-out"><button class="btn btn-primary">Log
						out</button></a>
			</div>
		</div>
		<div class="flex-item-right">
			<h6>AVATAR</h6> <img alt=""
